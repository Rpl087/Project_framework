...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | LabManager</title>
...
<body>
    <div style="text-align:center;max-width:400px;padding:2rem;">
        ...
        <h1 style="font-size:2rem;font-weight:800;color:#f1f5f9;margin-bottom:0.5rem;">404</h1>
        <h2 style="font-size:1.1rem;font-weight:600;color:#94a3b8;margin-bottom:0.75rem;">Halaman Tidak Ditemukan</h2>
